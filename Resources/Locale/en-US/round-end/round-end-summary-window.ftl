...
round-end-summary-window-player-info-if-not-observer-text = [color=gray]{$playerOOCName}[/color] was [color={$icNameColor}]{$playerICName}[/color] playing the role of [color=orange]{$playerRole}[/color]. They [color={$deadColor}]{$dead}[/color] of the round.
